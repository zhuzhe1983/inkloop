...
INKLOOP_WAV_SYMBOL(display_refresh_start);
INKLOOP_WAV_SYMBOL(device_restored);
INKLOOP_WAV_SYMBOL(ordinal_prefix);
INKLOOP_WAV_SYMBOL(ordinal_digit_zero);
INKLOOP_WAV_SYMBOL(ordinal_digit_one);
INKLOOP_WAV_SYMBOL(ordinal_digit_two);
INKLOOP_WAV_SYMBOL(ordinal_digit_three);
INKLOOP_WAV_SYMBOL(ordinal_digit_four);
INKLOOP_WAV_SYMBOL(ordinal_digit_five);
INKLOOP_WAV_SYMBOL(ordinal_digit_six);
INKLOOP_WAV_SYMBOL(ordinal_digit_seven);
INKLOOP_WAV_SYMBOL(ordinal_digit_eight);
INKLOOP_WAV_SYMBOL(ordinal_digit_nine);
INKLOOP_WAV_SYMBOL(ordinal_ten);
INKLOOP_WAV_SYMBOL(ordinal_suffix);
...
const PromptAsset kPrompts[] = {
    ...
    INKLOOP_PROMPT("display.refresh_start", display_refresh_start),
    INKLOOP_PROMPT("device.restored", device_restored),
    INKLOOP_PROMPT("ordinal.prefix", ordinal_prefix),
    INKLOOP_PROMPT("ordinal.digit_zero", ordinal_digit_zero),
    INKLOOP_PROMPT("ordinal.digit_one", ordinal_digit_one),
    INKLOOP_PROMPT("ordinal.digit_two", ordinal_digit_two),
    INKLOOP_PROMPT("ordinal.digit_three", ordinal_digit_three),
    INKLOOP_PROMPT("ordinal.digit_four", ordinal_digit_four),
    INKLOOP_PROMPT("ordinal.digit_five", ordinal_digit_five),
    INKLOOP_PROMPT("ordinal.digit_six", ordinal_digit_six),
    INKLOOP_PROMPT("ordinal.digit_seven", ordinal_digit_seven),
    INKLOOP_PROMPT("ordinal.digit_eight", ordinal_digit_eight),
    INKLOOP_PROMPT("ordinal.digit_nine", ordinal_digit_nine),
    INKLOOP_PROMPT("ordinal.ten", ordinal_ten),
    INKLOOP_PROMPT("ordinal.suffix", ordinal_suffix),
