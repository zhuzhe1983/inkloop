...
enum class RenderStrategy : uint8_t { OfficialQuality, ExperimentalSixColor };
...
// experimental policy performs deterministic Floyd-Steinberg error diffusion
// into only the six verified PaperColor colors. Both descriptors require a
// full-screen ED2208 refresh.
